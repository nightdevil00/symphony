...
# Symphony - Cava Color Updater
# Updates cava config with theme colors
# Usage: ./update-cava-colors.sh <theme-name>
...
if [ "$THEME" = "matugen" ]; then
  CAVA_COLORS="$THEMES_DIR/matugen/.config/cava/colors.ini"
